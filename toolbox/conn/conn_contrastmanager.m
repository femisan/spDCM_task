...
ht_add=uicontrol(thfig,'style','pushbutton','string','New','units','norm','position',[.8,.75,.15,.10],'callback',@(varargin)conn_contrastmanager_update('add'),'fontsize',8+CONN_gui.font_offset,'tooltipstring','Adds current contrast definition (defined in the main CONN gui) to this list');
